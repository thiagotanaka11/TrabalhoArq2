...
void res_station::exec()
{
    while(true)
    {
        ...
        else if(op.substr(0,4) == "ADDD") 
        {
            res1 = vj + vk;
            fp = 1;
        }
        else if(op.substr(0,4) == "SUBS")
        {
            res1 = vj - vk;
            fp = 1;
        }
        else if(op.substr(0,4) == "MULD")
        {
            res1 = vj*vk;
            fp = 1;
        }
        else if(op.substr(0,4) == "DIVS")
        {
            if(vk) 
            {
                res1 = vj/vk;
